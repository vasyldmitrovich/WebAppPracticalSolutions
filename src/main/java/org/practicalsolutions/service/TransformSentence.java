...
public class TransformSentence {
        ...
        for (int i = 0; i < string.length(); i++) {
            ...
            switch (oneLetter) {
                ...
                case 'Z':
                    ...
                    break;
                case ' ':
                    plusLetter(numberFree());
                    break;
                case '0':
                    plusLetter(numberZero());
                    break;
                case '1':
                    plusLetter(numberOne());
                    break;
                case '2':
                    plusLetter(numberTwo());
                    break;
                case '3':
                    plusLetter(numberThree());
                    break;
                case '4':
                    plusLetter(numberFour());
                    break;
                case '5':
                    plusLetter(numberFive());
                    break;
                case '6':
                    plusLetter(numberSix());
                    break;
                case '7':
                    plusLetter(numberSeven());
                    break;
                case '8':
                    plusLetter(numberEight());
                    break;
                case '9':
                    plusLetter(numberNine());
                    break;
                case '?':
                    plusLetter(symbolQuestion());
                    break;
                case '!':
                    plusLetter(symbolWTF());
                    break;
                case '(':
                    plusLetter(symbolBrackets1());
                    break;
                case ')':
                    plusLetter(symbolBrackets2());
                    break;
                case '.':
                    plusLetter(symbolPoint());
                    break;
    ...
    private void plusLetter(String[][] str) {
        ...
        for (int i = 0; i < rows; i++) {
            System.arraycopy(str[i], indexArray - indexArray, strings[i], indexArray, indexArray + columns - indexArray);
        }
